...
async function GET() {
    try {
        const logs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$shield$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["shield"].storage.getLogs(50); // get last 50 logs
        const dateKey = new Date().toISOString().split('T')[0];
        const todaySpend = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$shield$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["shield"].storage.getDailySpend(dateKey);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            logs,
            todaySpend,
            dailyLimit: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$shield$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["shield"].config.dailyLimit
        });
    } catch (err) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: err.message
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0pgqdjo._.js.map